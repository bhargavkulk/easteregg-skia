...
RECORD(DrawPicture, kDraw_Tag | kHasPaint_Tag, Optional<SkPaint> paint;
       ...
       TypedMatrix matrix)
RECORD(DrawPoints, kDraw_Tag | kHasPaint_Tag | kMultiDraw_Tag, SkPaint paint;
...
RECORD(DrawTextBlob, kDraw_Tag | kHasText_Tag | kHasPaint_Tag, SkPaint paint;
       ...
       SkScalar x;
       SkScalar y)
RECORD(DrawSlug, kDraw_Tag | kHasText_Tag | kHasPaint_Tag, SkPaint paint;
...
RECORD(DrawPatch, kDraw_Tag | kHasPaint_Tag, SkPaint paint; PODArray<SkPoint> cubics;
       ...
       SkBlendMode bmode)
RECORD(DrawAtlas,
       kDraw_Tag | kHasImage_Tag | kHasPaint_Tag | kMultiDraw_Tag,
...
RECORD(DrawVertices, kDraw_Tag | kHasPaint_Tag | kMultiDraw_Tag, SkPaint paint;
       sk_sp<SkVertices> vertices;
       SkBlendMode bmode)
RECORD(DrawMesh, kDraw_Tag | kHasPaint_Tag | kMultiDraw_Tag, SkPaint paint; SkMesh mesh;
       sk_sp<SkBlender> blender)
RECORD(DrawShadowRec, kDraw_Tag, PreCachedPath path; SkDrawShadowRec rec)
RECORD(DrawAnnotation,
       0,  // TODO: kDraw_Tag, skbug.com/40036727
       SkRect rect;
       SkString key;
       sk_sp<SkData> value)
